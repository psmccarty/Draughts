...
public class CheckersBoard extends JFrame{
	...
	private ArrayList<Square> p1Pieces;					// List of squares where there are pieces belonging to player1
	private ArrayList<Square> p2Pieces;					// List of squares where there are pieces belonging to player2
	private static final String ICONPATH = "images/checkersIcon.png";	// Path to the icon of the app
	private JLayeredPane pane;						// Pane where all the GUI elements reside
	...
	public void interruptMessage(String message){
		...
		lab.setIcon(new ImageIcon("images/trophy.png"));
